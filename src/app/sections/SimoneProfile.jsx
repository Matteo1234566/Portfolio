    ...
    return (
        <div className="bg-paper dark:bg-ink min-h-screen font-body text-ink dark:text-white pb-20">
            ...
            <span className="bg-forest text-white px-4 py-2 rounded-full font-bold uppercase tracking-wider text-sm md:text-base">
              ...
              // AI Specialist & System Architect
            </span>
                    </motion.div>
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <div className="space-y-6 text-lg leading-relaxed text-ink/80 dark:text-smoke">
                            <p>
                                My journey into technology began in my teenage years, fueled by a curiosity for building websites and experimenting with design. That spark led me to a formal path in Computer Science at <strong className="text-ink dark:text-white">La Sapienza University of Rome</strong>, where I graduated with top honors <span className="bg-bubblegum/20 px-2 py-0.5 rounded text-bubblegum font-bold">(110/110 cum laude)</span>.
                            </p>
                            <p>
                                Today, as Co-Founder & CTO of 4AI, I bridge the gap between academic research and production-ready software. I don't just write code; I architect systems. Whether it's Deep Learning, Computer Vision, or Data Engineering, my goal is to transform advanced concepts into innovative, usable platforms.
                            </p>
                            <p>
                                I thrive in dynamic environments where technical precision meets creative problem-solving.
                            </p>
                        </div>
                    </motion.div>
                    <motion.div
                    ...
                    >
                        <Card className="!p-0 overflow-hidden bg-forest relative aspect-square md:aspect-[4/5] flex items-center justify-center">
                            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-bubblegum/40 via-forest to-forest"></div>
                            <div className="relative z-10 text-center p-8">
                                <Cpu size={80} className="text-white mx-auto mb-6 opacity-80" />
                                <h3 className="font-display text-3xl text-white uppercase mb-2">The Architect</h3>
                                <div className="w-16 h-1 bg-bubblegum mx-auto"></div>
                            </div>
                        </Card>
                    </motion.div>
                </div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <Card dark className="!bg-ink !border-white/10">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-3 text-white/90">
                                    ...
                                    <span className="font-bold">YOLO / Scikit-learn</span>
                                </div>
                            </div>
                        </Card>
                        ...
                        <Card className="bg-paper border-ink/10">
                            ...
                            <h3 className="font-display text-2xl font-bold text-ink dark:text-white mb-4">Full Stack</h3>
                        ...
                        <Card className="bg-white border-ink/10 dark:bg-white/5">
                            ...
                            <p className="text-ink/60 dark:text-white/60 mb-6 text-sm">
                                Research Fellow at La Sapienza, working on cutting-edge sensing tech.
                            </p>
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="group border-l-2 border-white/20 pl-8 hover:border-bubblegum transition-colors duration-300">
                            ...
                            <div className="bg-white/5 p-6 rounded-xl border border-white/10">
                                <h4 className="font-bold mb-2 text-sm uppercase tracking-wider text-white/80">My Role</h4>
                                <p className="text-white/70">
                                    Engineered advanced pre- and post-processing pipelines to ensure high-accuracy text generation.
                                </p>
                            </div>
                        </div>
